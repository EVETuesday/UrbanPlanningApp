...
namespace UrbanPlanningApi.Controllers
{
    ...
    public class TestController : ControllerBase
    {
        ...
        public string AddClient(Client client) //Добавление нового клиента
        {
            ...
            SqlCommand sc = new SqlCommand("insert into Client(LastName, FirstName,Patronymic,Birthday,Phone,IsLegalEntity,PasportSeries,PasportNumber, CompanyTitle,INN,KPP,OGRN,PaymentAccount,CorrespondentAccount,BIK,IDGender, Login, Password)\r\nvalues('" + client.LastName + "','" + client.FirstName + "','" + client.Patronymic + "','" + client.Birthday + "','" + client.Phone + "'," + Convert.ToInt32(Convert.ToBoolean(client.IsLegalEntity)) + "," + client.PasportSeries + "," + client.PasportNumber + "," + client.CompanyTitle + "," + client.INN + "," + client.KPP + "," + client.OGRN + "," + client.PaymentAccount + "," + client.CorrespondentAccount + "," + client.BIK + "," + client.IDGender + ",'"+client.Login+"','"+client.Password+"')", sqlConnection);
            sqlConnection.Open();
